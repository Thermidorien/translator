...
#3 things to do:
#change name of test.py
#remove items that are not in Lebanese dialect (look through data.json generated by test.py, there is a key that checks the dialects for a particular word)
#add a button in trnaslator to change the arabic_latin of the csv if I dont like it
